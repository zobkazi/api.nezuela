...
let PostController = class PostController {
    ...
    async findAll(page, limit, search, category, tags, sortBy) {
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'tags', required: false, isArray: true, type: String }),
    (0, swagger_1.ApiQuery)({ name: 'sortBy', required: false, enum: ['asc', 'desc'] }),
